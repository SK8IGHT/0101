import fastapi
from src.server.resolves import culture as resolve
from src.database.models import Culture as Model

router = fastapi.APIRouter(prefix='/culture', tags=['Culture'])
